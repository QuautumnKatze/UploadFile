...
<div class="container mx-auto px-32">
    <div class="my-4">
        <img alt="" class="w-2/3 mx-auto h-90" height="10" src="{{ asset('img/default/banner-1.png') }}" width="720" />
    </div>


    <div class="flex space-x-4 my-4">
        <img alt="" class="w-1/3" height="280" src="{{asset("img/default/banner-2.png")}}" width="300" />
